...
### **공통**
   - [O] [뱅크샐러드 홈페이지]([https://www.banksalad.com/](https://www.banksalad.com/))에 보이는 모든 요소를 **구현**해야 한다.
   - [O] **시멘틱 태그**를 적절히 사용해야 한다.
   - [O] **웹 폰트**로 “Pretendard”를 적용해야 한다.
   - [O] **이미지**는 뱅크샐러드 홈페이지의 리소스를 사용한다.
...
<img width="1000" alt="image" src="https://github.com/5uhwann/random_meal_toy/assets/106325839/c924ebba-bd94-4f6d-b47f-6bca73a58f98">
   ...
   - [O] 헤더 **항상 상단**에 고정되어 있어야 한다.
   - [O] 네비게이션의 각 요소에 **hover**시, 텍스트가 **초록색**으로 변해야 한다.
...
- [0] 광고 슬라이드는 **4초**에 한 번씩 **자동**으로 다음 슬라이드 넘어가야 한다.
  - [O] 마지막 슬라이드에 도달 시, 첫 번째 슬라이드 이동해야 한다. 
- [O] 광고 슬라이드의 하단 버튼(흰색)을 클릭하면, 해당 순서의 슬라이드로 **이동**해야 한다.
...
- [O] 왼쪽, 오른쪽 버튼(화살표) 클릭 시, 사진과 텍스트가 변해야 한다.
